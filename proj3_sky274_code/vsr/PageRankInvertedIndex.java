...
public class PageRankInvertedIndex extends InvertedIndex{
    ...
    public Map<String, Double> ranks;
  ...
  public void indexDocuments() {
    ...
    int i= 0;
    while (i< maxCount && docIter.hasMoreDocuments()) {
    ...
    System.out.println("\nIndexed " + docRefs.size() + " documents with " + size() + " unique terms.");
      ...
      protected void parsePageRank(){
        ...
        try {
            ...
            while(true){
                ...
                ranks.put(split[0], Double.parseDouble(split[1]));
      ...
      protected Retrieval getRetrieval(double queryLength, DocumentReference docRef, double score) {
        ...
        score = score / (queryLength * docRef.length) + (weight * ranks.get(docRef.toString()));
